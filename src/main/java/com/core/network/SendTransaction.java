...
public class SendTransaction {
    public static TrxReceipt SignAndSend(Network network, RawTransaction rawTransaction, String privateKey,
            String publicKey)
            throws Exception {
        Web3j w3 = network.value.w3;
        // String publicKey = "0xcd3B766CCDd6AE721141F452C550Ca635964ce71";
